...
workspace_name = "mlproject" # PLACEHOLDER
subscription_id = "c7261a9b-9ffb-46f9-a6ef-61eefdc69f66" # PLACEHOLDER
resource_group = "boqun.shu-rg" # PLACEHOLDER
experiment_name = "boqun" # PLACEHOLDER
iteration = "49"  # PLACEHOLDER
run_id = "AutoML_bc980414-a5e8-47ca-a5f7-3ef9d6acd4b4_49"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'automl1','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':360,'featurization':'auto','hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':360,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'boqun','path':'./sample_projects/boqun','primary_metric':'normalized_root_mean_squared_error','region':'eastus2','resource_group':'boqun.shu-rg','subscription_id':'c7261a9b-9ffb-46f9-a6ef-61eefdc69f66','task_type':'regression','validation_size':None,'test_size':0.3,'vm_type':'STANDARD_D4S_V3','workspace_name':'mlproject','label_column_name':'cost','enable_batch_run':True,'dataset_id':'40f87c9a-a665-478d-8fbe-f2c5190fedac'} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Stack_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.stack_ensemble\",\"class_name\":\"StackEnsemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','ensemble_iterations':15,'is_timeseries':False,'name':'boqun','compute_target':'automl1','subscription_id':'c7261a9b-9ffb-46f9-a6ef-61eefdc69f66','region':'eastus2','grain_column_names':None}\",\"ensemble_run_id\":\"AutoML_bc980414-a5e8-47ca-a5f7-3ef9d6acd4b4_49\",\"experiment_name\":\"boqun\",\"workspace_name\":\"mlproject\",\"subscription_id\":\"c7261a9b-9ffb-46f9-a6ef-61eefdc69f66\",\"resource_group_name\":\"boqun.shu-rg\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Stack_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"40f87c9a-a665-478d-8fbe-f2c5190fedac\"}}" # PLACEHOLDER
